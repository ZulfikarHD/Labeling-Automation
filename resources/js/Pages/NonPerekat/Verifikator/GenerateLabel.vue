    ...
    <Modal :show="printUlangModal" @close="Modal => printUlangModal = !printUlangModal">
        <div class="flex flex-col gap-4 px-4 py-4">
            ...
            <div class="flex flex-wrap justify-center gap-4 mt-4">
                <button v-for="n in dataPrintUlang" type="button" v-bind:key="refresh" @click="pilihRim(n.no_rim,n.np_users)" class="min-w-[8ch] px-4 py-2 text-xs bg-slate-500 text-slate-50 hover:brightness-95 duration-300 transition ease-in-out rounded drop-shadow shadow">
        ...
        <div class="flex flex-col justify-center py-8">
            <form>
                ...
                <div class="flex justify-center gap-6 mx-auto w-fit">
                    ...
                    <button type="button" @click="[getDataRim(), printUlangModal = !printUlangModal]"
                        class="flex justify-center px-4 py-4 mx-auto mt-8 shadow-md w-fit bg-gradient-to-r from-green-400 to-green-500 rounded-xl text-start hover:brightness-90 drop-shadow-md shadow-green-500/20">
            ...
            <div class="flex gap-6 mx-auto mt-10">
                <Link :href="route('np.generateLabels.index')"
