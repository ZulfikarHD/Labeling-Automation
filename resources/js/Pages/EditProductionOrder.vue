...
// Add function to fetch updated label data
...
const updateLabel = async () => {
    ...
    try {
        await axios.post(`/api/production-order/update-label`, labelForm);
...
const updateOrder = async () => {
    ...
    if (result.isConfirmed) {
        try {
            const response = await axios.post("/api/production-order/update-rim", form);
