                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="bg-slate-50/50 dark:bg-slate-700/50 rounded-xl p-6">
                            <div class="flex items-center justify-center gap-3 mb-3">
                                ...
                                <InputLabel for="po" value="Nomor PO" class="text-lg font-semibold text-slate-700 dark:text-slate-300"/>
                            </div>
                            <TextInput
                                id="po"
                                ref="po"
                        ...
                        <div class="bg-slate-50/50 dark:bg-slate-700/50 rounded-xl p-6">
                            <div class="flex items-center justify-center gap-3 mb-3">
                                ...
                                <InputLabel for="seri" value="Nomor Seri" class="text-lg font-semibold text-slate-700 dark:text-slate-300"/>
                            </div>
                            <TextInput
                                id="seri"
                                ref="seri"
