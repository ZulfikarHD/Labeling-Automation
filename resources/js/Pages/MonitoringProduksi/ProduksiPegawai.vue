        ...
        <div class="relative min-h-screen py-12">
            <div class="max-w-[95%] mx-auto">
                ...
                <div class="max-w-md mx-auto mb-12">
                    <div class="relative">
                        <InputLabel for="dateFilter"
                            class="block text-sm font-medium text-blue-700 dark:text-blue-300 mb-2">
                            Tanggal Produksi
                        </InputLabel>
                        <div class="relative">
                            <Calendar
                                class="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-blue-400 dark:text-blue-500" />
                ...
                <div class="relative">
                    ...
                    <div v-if="!isLoading && activeTeams.length === 0" class="text-center py-12">
                        <p class="text-lg text-gray-600 dark:text-gray-400">
                            Tidak ada data produksi PCHT untuk tanggal ini
                        </p>
                    </div>
