        ...
        <div class="min-h-screen py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            <div class="max-w-[95%] mx-auto">
                ...
                <div class="text-center mb-12">
                    <h1 class="text-4xl font-bold text-slate-900 tracking-tight sm:text-5xl">
                ...
                <div class="max-w-md mx-auto mb-12">
                    <div class="relative">
                        ...
                        <div class="relative">
                            <Calendar class="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400" />
                            <TextInput
                                id="dateFilter"
                                type="date"
                                v-model="form.date"
                                class="pl-12 w-full rounded-xl border-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-12">
                    <template v-for="team in props.teams" :key="'team'+team.id">
                        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                            <div class="pt-4">
                                <h3 class="text-xl font-semibold text-slate-900 mb-4 text-center">
                ...
                <!-- All Teams Section -->
                <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-lg transition-all duration-300 w-fit mx-auto">
                    <div class="pt-4">
                        <h3 class="text-xl font-semibold text-slate-900 mb-4 text-center">
                            Semua Team
                        </h3>
