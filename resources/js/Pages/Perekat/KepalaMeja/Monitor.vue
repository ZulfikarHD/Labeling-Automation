    ...
    <div class="py-8">
      ...
      <div class="mx-auto mt-2 w-fit">
        <InputLabel
          for="team"
          value="Team"
          class="text-2xl font-extrabold text-center uppercase"
        />
        ...
        <div class="flex items-start justify-between w-full gap-12">
              ...
              <template v-for="status in dataRim">
                <template v-if="status.potongan == 'Kiri'">
                  ...
                  <div
                    ...
                    class="px-2 py-1 rounded-md shadow bg-gradient-to-br from-green-300 to-green-400 drop-shadow shadow-green-400/30"
                  >
                    <div class="flex flex-col justify-center w-[4ch]">
                      <span
                        class="text-xs font-extrabold leading-5 text-center text-green-950"
                        >{{ status.np_users }}</span
                      >
                      <span
                        class="text-xs font-extrabold leading-5 text-center text-indigo-700"
                        >{{ status.no_rim }}</span
                      >
                    </div>
                  </div>
                  ...
                  <div
                    v-else-if="status.start != null && status.finish == null"
                    class="px-2 py-1 rounded-md shadow bg-gradient-to-br from-yellow-300 to-yellow-400 drop-shadow shadow-yellow-400/30"
                  >
                    <div class="flex flex-col justify-center w-[4ch]">
                      <span
                        class="text-xs font-extrabold leading-5 text-center text-green-950"
                  ...
                  <div
                    v-else
                    class="px-2 py-1 rounded-md shadow bg-gradient-to-br from-slate-300 to-slate-400 drop-shadow shadow-slate-400/30"
                  >
                    <div class="flex flex-col justify-center w-[4ch]">
                      <span
                        class="text-xs font-extrabold leading-5 text-center text-green-950"
          ...
          <div class="flex flex-col justify-center gap-4 mt-16 w-fit">
            <div class="flex items-center gap-2">
              <span
                class="px-6 py-2 rounded-md shadow bg-gradient-to-br from-green-300 to-green-400 drop-shadow shadow-green-400/30"
              ></span>
              <span class="font-medium text-slate-600">Selesai Verif</span>
            </div>
            <div class="flex items-center gap-2">
              <span
                class="px-6 py-2 rounded-md shadow bg-gradient-to-br from-yellow-300 to-yellow-400 drop-shadow shadow-yellow-400/30"
              ></span>
              <span class="font-medium text-slate-600">Proses Verif</span>
            </div>
            <div class="flex items-center gap-2">
              <span
                class="px-6 py-2 rounded-md shadow bg-gradient-to-br from-slate-300 to-slate-400 drop-shadow shadow-slate-400/30"
              ></span>
