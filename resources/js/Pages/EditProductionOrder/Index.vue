    ...
    <AuthenticatedLayout>
        <div class="min-h-screen py-12 ">
            <div class="container mx-auto px-4 max-w-7xl">
                ...
                <MainInfoForm :data-po="dataPo" :spec-po="specPo" :team-list="teamList" @update:form="updateMainInfo" />
                ...
                <div
                    ...
                    <RimInfoForm :data-po="dataPo" :inschiet="inschiet" @update:form="updateRimInfo" />
                </div>

                <!-- Status Section -->
                <StatusSection :labels="labels" :no-po="dataPo.no_po" @edit-label="openEditModal"
                    @add-rim="showAddRimModal = true" @delete-labels="handleBatchDelete"
                    @refresh-data="refreshLabelData" />

                <!-- Modals -->
                <EditLabelModal v-model:show="showEditModal" :selected-label="selectedLabel" :team-list="teamList"
                    :default-team="dataPo.assigned_team" @label-updated="refreshLabelData" />

                <AddRimModal v-model:show="showAddRimModal" :data-po="dataPo" :labels="labels"
